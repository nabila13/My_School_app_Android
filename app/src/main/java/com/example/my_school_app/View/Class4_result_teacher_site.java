...
import com.example.my_school_app.Add_class4_result;
...
public class Class4_result_teacher_site extends AppCompatActivity {
Button button4;
//    private static final String JSON_URL = "http://10.0.2.2:8081/Software_project/get_class4_result.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class4_result_teacher_site);
        recyclerView4=findViewById(R.id.rv_student_view4);
        button4=findViewById(R.id.editData4);
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(), Add_class4_result.class);
        ...
        if(value.equalsIgnoreCase("Class 4")){
            ...
            Intent inter2=new Intent(getApplicationContext(),Class5_result_teacher_site.class);
...
//initializing the productlist
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Config_url.getClass4result, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Class4_result_teacher_site.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        });
