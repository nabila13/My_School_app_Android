...
public class Class1_studentinfo_guardian_site extends AppCompatActivity {
...
//      private static final String JSON_URL = "http://10.0.2.2:8081/Software_project/get_class1_stuinfo.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class1_studentinfo_guardian_site);
        Intent inter=getIntent();
        String value=inter.getStringExtra("val");

        if(value.equalsIgnoreCase("Class 1")){
            adddata();
        }
        else{
            Intent inter2=new Intent(getApplicationContext(),Class2_studentinfo_guardian_site.class);
            inter2.putExtra("val2",value);
            startActivity(inter2);
        }


        recyclerView2=findViewById(R.id.rv_stuinfo11);
    }
...
//initializing the productlist
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Config_url.getclass1info, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Class1_studentinfo_guardian_site.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        });
