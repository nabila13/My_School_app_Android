...
import com.example.my_school_app.Add_class3_student_info;
...
public class Class3_studentinfo_teacher_site extends AppCompatActivity {
Button addData;
   // private static final String JSON_URL = "http://10.0.2.2:8081/Software_project/get_class3_stuinfo.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class3_studentinfo_teacher_site);

        addData=findViewById(R.id.edit_stuinfo3);
        addData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ass=new Intent(getApplicationContext(), Add_class3_student_info.class);
                startActivity(ass);
            }
        });

        recyclerView5=findViewById(R.id.rv_stuinfo32);
        Intent acid=getIntent();
        String value=acid.getStringExtra("val3");
        if(value.equalsIgnoreCase("Class 3")){
            adddata();
        }
        else{
            Intent in=new Intent(getApplicationContext(),Class4_studentinfo_teacher_site.class);
            in.putExtra("val4",value);
            startActivity(in);
        }
    }
    public void adddata () {
//initializing the productlist
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Config_url.getclass3info, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Class3_studentinfo_teacher_site.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        });
