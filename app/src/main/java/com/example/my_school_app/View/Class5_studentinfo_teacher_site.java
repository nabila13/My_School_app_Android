...
import com.example.my_school_app.Add_class5_student_info;
...
public class Class5_studentinfo_teacher_site extends AppCompatActivity {
Button addData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class5_studentinfo_teacher_site);
        addData=findViewById(R.id.edit_stuinfo5);
        addData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ass=new Intent(getApplicationContext(), Add_class5_student_info.class);
                startActivity(ass);
            }
        });
        recyclerView10=findViewById(R.id.rv_stuinfo52);
        adddata();
    }
    public void adddata () {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Config_url.getclass5info, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    recyclerView10.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                    recyclerView10.setAdapter(viewAdapter);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(Class5_studentinfo_teacher_site.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        });
