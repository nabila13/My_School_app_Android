...
import com.example.my_school_app.View.Class3_studentinfo_teacher_site;

import java.util.HashMap;
import java.util.Map;

public class Add_class3_student_info extends AppCompatActivity {
   // private String insertDataURL = "http://10.0.2.2:8081/Software_project/add_class3_info.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_class3_student_info);


        insertData = (Button) findViewById(R.id.btnaddinfo3);
        previous=findViewById(R.id.btngoback3);


        editroll = findViewById(R.id.c_roll3);
        editname = findViewById(R.id.c_name3);
        editage = findViewById(R.id.c_age3);
        edit_gname =findViewById(R.id.c_guardian3);
        edit_contact=findViewById(R.id.c_number3);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ee=new Intent(getApplicationContext(), Class3_studentinfo_teacher_site.class);
                startActivity(ee);
            }
        });
    }
    ...
    public void insertdatanewway2() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,Config_url.insertclass3studentinfo, new Response.Listener<String>() {
            @Override
