...
import com.example.my_school_app.View.Class2_studentinfo_teacher_site;

import java.util.HashMap;
import java.util.Map;

public class Add_class2_student_info extends AppCompatActivity {

//    private String insertDataURL = "http://10.0.2.2:8081/Software_project/add_class2_info.php";

    private static String TAG = Add_class2_student_info.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_class2_student_info);


        insertData = (Button) findViewById(R.id.btnaddinfo2);
        previous=findViewById(R.id.btngoback2);


        editroll = findViewById(R.id.c_roll2);
        editname = findViewById(R.id.c_name2);
        editage = findViewById(R.id.c_age2);
        edit_gname =findViewById(R.id.c_guardian2);
        edit_contact=findViewById(R.id.c_number2);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ee=new Intent(getApplicationContext(), Class2_studentinfo_teacher_site.class);
                startActivity(ee);
            }
        });
    ...
    public void insertdatanewway2() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config_url.insertclass2studentinfo, new Response.Listener<String>() {
            @Override
