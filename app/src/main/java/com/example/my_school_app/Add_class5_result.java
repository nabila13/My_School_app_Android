   ...
   import com.example.my_school_app.View.Class5_result_teacher_site;

   import java.util.HashMap;
   import java.util.Map;

public class Add_class5_result extends AppCompatActivity {
    //private String insertDataURL = "http://10.0.2.2:8081/Software_project/add_class5_result.php";
    ...
    private Button insertData5,previous;
    double gpa,point;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_class5_result);
        insertData5=(Button)findViewById(R.id.btnadd5);
        previous=findViewById(R.id.btnaddcustomer5);
        ...
        insertData5.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent rr=new Intent(getApplicationContext(), Class5_result_teacher_site.class);
                startActivity(rr);
            }
        });
    }
    ...
    public void insertdatanewway2() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config_url.insertclass5result, new Response.Listener<String>() {
            @Override
