...
import com.example.my_school_app.View.Class5_studentinfo_teacher_site;

import java.util.HashMap;
import java.util.Map;

public class Add_class5_student_info extends AppCompatActivity {
  //  private String insertDataURL = "http://10.0.2.2:8081/Software_project/add_class5_info.php";

    private static String TAG = Add_class3_student_info.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_class5_student_info);

        insertData = (Button) findViewById(R.id.btnaddinfo5);
        previous=findViewById(R.id.btngoback5);


        editroll = findViewById(R.id.c_roll5);
        editname = findViewById(R.id.c_name5);
        editage = findViewById(R.id.c_age5);
        edit_gname =findViewById(R.id.c_guardian5);
        edit_contact=findViewById(R.id.c_number5);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ee=new Intent(getApplicationContext(), Class5_studentinfo_teacher_site.class);
                startActivity(ee);
            }
        });
    }
    ...
    public void insertdatanewway2() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config_url.insertclass5studentinfo, new Response.Listener<String>() {
            @Override
