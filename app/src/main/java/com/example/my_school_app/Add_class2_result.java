...
import com.example.my_school_app.View.Class2_result_teacher_site;

import java.util.HashMap;
import java.util.Map;

public class Add_class2_result extends AppCompatActivity {
 //   private String insertDataURL = "http://10.0.2.2:8081/Software_project/add_class2_result.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_class2_result);
        insertData=(Button)findViewById(R.id.btnaddcustomer);
        previous=findViewById(R.id.btnaddcustomer2);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent qq=new Intent(getApplicationContext(), Class2_result_teacher_site.class);
                startActivity(qq);
            }
        });
    }
    ...
    public void insertdatanewway2() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config_url.insertclass2result, new Response.Listener<String>() {
            @Override
