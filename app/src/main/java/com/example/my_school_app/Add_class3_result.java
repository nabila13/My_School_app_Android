...
import com.example.my_school_app.View.Class3_result_teacher_site;

import java.util.HashMap;
import java.util.Map;

public class Add_class3_result extends AppCompatActivity {
   // private String insertDataURL = "http://10.0.2.2:8081/Software_project/add_class3_result.php";
    ...
    private Button insertData3,previous;
    double gpa,point;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_class3_result);
        insertData3=(Button)findViewById(R.id.btnadd3);
        previous=findViewById(R.id.btnaddcustomer3);
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ww=new Intent(getApplicationContext(), Class3_result_teacher_site.class);
                startActivity(ww);
            }
        });
    ...
    public void insertdatanewway2() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config_url.insertclass3result, new Response.Listener<String>() {
            @Override
